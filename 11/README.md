...
rel="noopener">Keep Away</a> with your missing things!
...
monkeys operate based on _how worried you are about each item_.
...
- `Starting items` lists your _worry level_ for each item the monkey
...
your worry level to be _divided by three_ and rounded down to the
nearest integer.

The monkeys take turns inspecting and throwing items. On a single
monkey's _turn_, it inspects and throws all of the items it is holding
...
each monkey taking a single turn is called a _round_.

When a monkey throws an item to another monkey, the item goes on the
_end_ of the recipient monkey's list. A monkey that starts a round with
...
to focus on the _two most active_ monkeys if you want any hope of
getting your stuff back. Count the _total number of times each monkey
inspects items_ over 20 rounds:
...
inspect over 20 rounds. _What is the level of monkey business after 20
rounds of stuff-slinging simian shenanigans?_
...
from reaching _ridiculous levels_. You'll need to _find another way to
keep your worry levels manageable_.

At this rate, you might be putting up with these monkeys for a _very
long time_ - possibly _`10000` rounds_!
...
and 52013 times. Multiplying these together, the level of _monkey
business_ in this situation is now `2713310158`.
